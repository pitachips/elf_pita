...
def store_photo_path(instance, filename):
    return 'store_photos/store_{0}/official/{1}'.format(instance.id, filename)

def user_photo_path(instance, filename):
    return 'user_photos/user_{0}/{1}'.format(instance.user.id, filename)

def review_photo_path(instance, filename):
    return 'store_photos/store_{0}/from_reviews/user_{1}/{2}'.format(instance.store.id, instance.author.id, filename)
'''
